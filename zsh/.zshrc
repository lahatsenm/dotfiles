...
# tree
alias tree='eza --tree'
alias treel='eza --long --links --tree'
...
export PATH="/usr/local/texlive/2025/bin/x86_64-linux:$HOME/.local/bin/statusbar:$obin:/usr/local/go/bin:$GOBIN:$PATH"
